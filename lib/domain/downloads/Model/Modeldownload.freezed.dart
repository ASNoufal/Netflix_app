    ...
    return _then(_value.copyWith(
      posterPath: freezed == posterPath
          ...
          : posterPath // ignore: cast_nullable_to_non_nullable
              as String?,
      orginaltitle: freezed == orginaltitle
          ? _value.orginaltitle
...
class _$DownloadsImpl implements _Downloads {
  ...
  @override
  String toString() {
    return 'Downloads(posterPath: $posterPath, orginaltitle: $orginaltitle)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, posterPath, orginaltitle);
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
      ...
      @JsonKey(name: "original_title")
      required final String? orginaltitle}) = _$DownloadsImpl;
